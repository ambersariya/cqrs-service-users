...
final class ChangeEmailAddressCommand extends \Prooph\Common\Messaging\Command
{
    ...
    protected $messageName = 'App\Application\Command\User\ChangeEmailAddress\ChangeEmailAddressCommand';

    public function userId(): \App\Domain\User\UserId
    {
        return \App\Domain\User\UserId::fromString($this->payload['userId']);
    }

    public function email(): \App\Domain\User\ValueObject\Email
    {
        return \App\Domain\User\ValueObject\Email::fromString($this->payload['email']);
    }

    public static function with(\App\Domain\User\UserId $userId, \App\Domain\User\ValueObject\Email $email): ChangeEmailAddressCommand
    {
        return new self([
